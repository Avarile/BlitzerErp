...
#### Dashboard is a static page due to the mock server but not the live backend.

#### Implement the selection persistance of the page selection

1. A Reduc slice is required in the first place.
